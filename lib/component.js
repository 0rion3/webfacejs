...
import { DisplayStateManager } from './modules/display_state_manager.js'
...
export class Component extends extend_as("Component").mixins(
  ...
  constructor(options=null) {
    ...
    this.attribute_callbacks = {
      'default' : (attr_name, self) => {
        ...
        if(this.display_state_manager) this.display_state_manager.applyChanges();
      }
    };
  ...
  afterInitialize() {
    ...
    if(this.display_states) this.display_state_manager = new DisplayStateManager(this, this.display_state_manager_settings);

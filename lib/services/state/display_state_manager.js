...
export class DisplayStateManager extends StateManager {
  ...
  applyTransition() {
    var transition_promise        = super.applyTransition();
    var entities_for_state_action = this.pickTransitionsForState();
   ...
   * `this.last_state_change` property and (c) was just initiated and applyTransition() just called for it.
   * In this case (b) will be comletely ingored, as applyTransition() will rewrite `this.last_state_change`

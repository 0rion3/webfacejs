...
export class EditableSelectComponent extends extend_as("EditableSelectComponent").mix(SelectComponent).with() {
  ...
  constructor() {
    ...
    this.attribute_names  = [
      ...
      "allow_custom_value", "query_param_name", "ignore_external_click_id"
    ];
    ...
    this.native_events = ["arrow.click", "option.click", "!display_input.keyup", "!display_input.keydown", "!display_input.blur"];
    ...
    this.attribute_callbacks["disabled"] = (attr_name, self) => {
      if(self.get("disabled")) {
        ...
        this.findPart("display_input").value = "";
        this.findPart("input").value = "";
      }
      else
        self.behave("enable");
    };
  ...
  setValueFromManualInput() {
    if(this.focused_option) {
      this.set("input_value", this.focused_option);
    } else if(this.options.values.includes(this.current_input_value)) {
      this.setValueByInputValue(this.optionKeyForValue(this.current_input_value));
    } else if(this.options.keys.includes(this.attribute_casting["to_dom"]["default"](this.get("input_value")))) {
      return;
    } else if(this.get("allow_custom_value")) {
      this.set("input_value", this.current_input_value);
      this.set("display_value", this.current_input_value);

...
class DummyComponent extends extend_as("DummyComponent").mixins(Attributable) {
  ...
  constructor() {
    ...
    this.display_state_manager_settings = { default_state_action: "hide", multiple_attr_conditons_exclusivity: true }
    this.display_states = {
      attr1: [
  ...
  findPart() { return document.createElement('div'); }
  findChildrenByRole() { return this.children; }
  behave(b) {}
